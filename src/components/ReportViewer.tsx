...
export const ReportViewer = ({ report, validationData }: ReportViewerProps) => {
  ...
  const handleExportPdf = async () => {
    ...
    try {
      ...
      pdf.text('Generated by ORKESTRA Research Engine', pageWidth / 2, yPosition, { align: 'center' });
          ...
          <div className="flex items-center justify-between text-sm">
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 px-3 py-1.5 bg-primary/10 rounded-full">
                ...
                <span className="text-foreground font-medium">ORKESTRA Research Engine</span>
              </div>
